...
describe('selectWidget', () => {
  it('honors explicit controls', () => {
    expect(selectWidget(param({ user_interface: { control: 'DROPDOWN_LIST', label: '', group_label: '', decimals: null, single_step_removal: null }, allowed_values: ['a', 'b'] }))).toBe('select')
    expect(selectWidget(param({ user_interface: { control: 'CHECK_BOX', label: '', group_label: '', decimals: null, single_step_removal: null }, allowed_values: ['off', 'on'] }))).toBe('checkbox')
    expect(selectWidget(param({ user_interface: { control: 'MULTILINE_EDIT', label: '', group_label: '', decimals: null, single_step_removal: null } }))).toBe('textarea')
    expect(selectWidget(param({ user_interface: { control: 'CHIP_INPUT', label: '', group_label: '', decimals: null, single_step_removal: null } }))).toBe('chips')
    expect(selectWidget(param({ user_interface: { control: 'SPIN_BOX', label: '', group_label: '', decimals: null, single_step_removal: null }, type: 'INT' }))).toBe('number')
    expect(selectWidget(param({ user_interface: { control: 'HIDDEN', label: '', group_label: '', decimals: null, single_step_removal: null } }))).toBe('hidden')
  })
...
describe('helpers', () => {
  it('paramLabel prefers the UI label', () => {
    expect(paramLabel(param({ name: 'Scene', user_interface: { control: 'LINE_EDIT', label: 'Scene file', group_label: '', decimals: null, single_step_removal: null } }))).toBe('Scene file')
