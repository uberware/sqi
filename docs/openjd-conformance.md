...
| Suite | Result |
|---|---|
| `base/job_templates` | 390 / 449 pass (59 baselined) |
...
768 fixtures collected in total: 400 live passes, 60 baselined failures, 308
not applicable.

Of the 59 baselined `base/job_templates` failures, all 59 are `.invalid` fixtures
