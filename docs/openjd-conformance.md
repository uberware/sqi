...
| Suite | Result |
|---|---|
| `base/job_templates` | 439 / 449 pass (10 baselined) |
...
768 fixtures collected in total: 449 live passes, 11 baselined failures, 308
not applicable.

Of the 10 baselined `base/job_templates` failures, all 10 are `.invalid` fixtures
