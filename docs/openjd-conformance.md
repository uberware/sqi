...
| Suite | Result |
|---|---|
| `base/job_templates` | 412 / 449 pass (37 baselined) |
...
768 fixtures collected in total: 422 live passes, 38 baselined failures, 308
not applicable.

Of the 37 baselined `base/job_templates` failures, all 37 are `.invalid` fixtures
