...
| Suite | Result |
|---|---|
| `base/job_templates` | 341 / 449 pass (108 baselined) |
...
768 fixtures collected in total: 351 live passes, 109 baselined failures, 308
not applicable.

Of the 108 baselined `base/job_templates` failures, all 108 are `.invalid` fixtures
