...
| Suite | Result |
|---|---|
| `base/job_templates` | 403 / 449 pass (46 baselined) |
...
768 fixtures collected in total: 413 live passes, 47 baselined failures, 308
not applicable.

Of the 46 baselined `base/job_templates` failures, all 46 are `.invalid` fixtures
