...
| Suite | Result |
|---|---|
| `base/job_templates` | 426 / 449 pass (23 baselined) |
...
768 fixtures collected in total: 436 live passes, 24 baselined failures, 308
not applicable.

Of the 23 baselined `base/job_templates` failures, all 23 are `.invalid` fixtures
