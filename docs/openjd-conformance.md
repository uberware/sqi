...
| Suite | Result |
|---|---|
| `base/job_templates` | 432 / 449 pass (17 baselined) |
...
768 fixtures collected in total: 442 live passes, 18 baselined failures, 308
not applicable.

Of the 17 baselined `base/job_templates` failures, all 17 are `.invalid` fixtures
