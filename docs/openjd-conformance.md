...
| Suite | Result |
|---|---|
| `base/job_templates` | 419 / 449 pass (30 baselined) |
...
768 fixtures collected in total: 429 live passes, 31 baselined failures, 308
not applicable.

Of the 30 baselined `base/job_templates` failures, all 30 are `.invalid` fixtures
