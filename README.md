...
- **DCC submitter widgets** in Python/Qt for in-application submission from Maya, Houdini, Nuke, and other tools. The [`sqi-client` Python library](docs/python-client.md) covers scripted submission and pipeline integration.
